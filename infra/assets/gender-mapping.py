...
AWS_GLUE_DATABASE_NAME = os.environ.get("AWS_GLUE_DATABASE_NAME")
AWS_GLUE_TABLE_NAME = os.environ.get("AWS_GLUE_TABLE_NAME")
...
datasink2 = glueContext.write_dynamic_frame.from_options(frame = applymapping1, connection_type = "s3", connection_options = {"path": f"s3://{S3_BUCKET_NAME}"}, format = "csv", transformation_ctx = "datasink2")
job.commit()